(function ($, window, document, undefined) {
  ...
  function audioPlayerUtils(element, options) {
    this.element = element;
    this.options = $.extend({}, defaults, this.options);
    this.init();
  }

  audioPlayerUtils.prototype.init = function () {};

  $.fn.audioPlayerUtils = function (options) {
    return this.each(function () {
      if (!$.data(this, "plugin")) {
        $.data(this, "plugin", new audioPlayerUtils(this, options));
      }
      ...
      var thePlayer = $(
        <div class="audioPlayer" style="margin: 50px">
          ...
          <a id="volumeBtn">
            <i
              class="fa fa-volume-up volume"
              style="color: #4050ab"
              aria-hidden="true"
            ></i>
            <i
              class="fa fa-volume-off muting"
              aria-hidden="true"
              style="display: none; color: #fd4f1a; margin-right: 8px"
            ></i>
          </a>
        </div>
      );
